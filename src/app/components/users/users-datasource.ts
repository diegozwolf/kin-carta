...
const EXAMPLE_DATA: UsersItem[] = [
  ...
  {id: 2, name: 'Helium',  lastName: 'Doe'},
  {id: 3, name: 'Lithium', lastName: 'Doe'},
  {id: 4, name: 'Beryllium', lastName: 'Doe'},
  {id: 5, name: 'Boron', lastName: 'Doe'},
  {id: 6, name: 'Carbon', lastName: 'Doe'},
  {id: 7, name: 'Nitrogen', lastName: 'Doe'}
];
